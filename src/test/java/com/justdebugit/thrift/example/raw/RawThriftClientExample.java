...
public class RawThriftClientExample 
{
    ...
    {   
        BlackServiceStub blackServiceStub = new BlackServiceStub("127.0.0.1",8080);
        System.out.println(blackServiceStub.isBlack(11));
        UserManagerServiceStub userManagerServiceStub = new UserManagerServiceStub("127.0.0.1", 8080);
